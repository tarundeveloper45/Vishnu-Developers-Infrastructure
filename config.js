window.VDI_CONFIG = {
  ...
  plans: {
    ...
    "stilt": { title: "Stilt Floor", area: "Details to be confirmed", image: "", description: "Verified parking and circulation plan is awaiting publication approval." },
    "typical": { title: "Typical Floor", area: "Details to be confirmed", image: "", description: "The verified typical-floor drawing will be published when supplied." },
    "terrace": { title: "Terrace", area: "Details to be confirmed", image: "", description: "The verified terrace drawing will be published when supplied." }
  }
};
